      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            ...
            <p className="mt-1 text-slate-600">Manage your video testimonial campaigns</p>
          </div>
        ...
        {campaigns.length === 0 ? (
          <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
            ...
            <p className="text-slate-600 mb-6">Create your first campaign to start collecting video testimonials.</p>
            <Link
              href="/dashboard/new"
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      {campaign.company_name && (
                        <p className="text-sm text-slate-500">{campaign.company_name}</p>
                      )}
                    </div>
